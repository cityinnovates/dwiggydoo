...
class ProductController extends Controller
{
    ...
    {
        return new ProductCollection(Product::where('website_type', 2)->latest()->paginate(10));
    }
    ...
    public function show($id)
    {
		...
		return new ProductDetailCollection(Product::where('slug', $id)->where('website_type', 2)->get());
    }
