...
class ProductController extends Controller
{
    ...
    public function admin_products(Request $request)
    {
        ...
        $products = $products->where('digital', 0)->where('website_type', 2)->orderBy('created_at', 'desc')->paginate(15);
    ...
    public function all_products(Request $request)
    {
        ...
        $products = $products->where('website_type',2)->paginate(15);
        $type = 'All';
    ...
    public function create()
    {
        ...
        $city = DB::table('city')->orderBy('created_at', 'desc')->get();
        return view('backend.product.products.create', compact('categories','attributes','city'));
    }
     ...
     */
     public function admin_product_edit(Request $request, $id)
     {
        ...
        $categories = Category::all();
         $attributes = DB::table('breed')->orderBy('created_at', 'desc')->get();
         $city = DB::table('city')->orderBy('created_at', 'desc')->get();
        return view('backend.product.products.edit', compact('product', 'categories', 'tags','lang','attributes','city'));
     }
