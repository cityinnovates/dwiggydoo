...
<div class="aiz-titlebar text-left mt-2 mb-3">
	...
	<div class="row align-items-center">
		...
		<div class="col">
			...
			<h1 class="h3"><?php echo e(translate('Edit BlogPage slider Information')); ?></h1>
...
<div class="card">
	...
	<form class="p-4" action="<?php echo e(route('custom-pages.blogupdateslider', $page->id)); ?>" method="POST" enctype="multipart/form-data">
	  ...
	  <h6 class="fw-600 mb-0">Blog slider Content</h6>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/backend/website_settings/pages/blogeditslider.blade.php ENDPATH**/ ?>