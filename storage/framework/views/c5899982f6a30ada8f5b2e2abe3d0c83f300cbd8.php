<section class="footer_top_sec pt-5 pb-5">
  <div class="container">
    <div class="row">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item <?php if($i==0){  ?> active<?php }  ?>">
              ...
              <div class="about_say d-flex align-items-center pt-4">
                <div class="about_say_img"><img src="<?php echo e(route('home')); ?>/images/new_xd_images/Samantha.png"></div>
      ...
      <div class="col">
        <img src="<?php echo e(route('home')); ?>/images/only-dog.png" alt="">
      </div>
    </div>
  </div>
  <br id="res">
  <br id="res"><br id="res"><br id="res">
</section><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/frontend/partials/testimonials.blade.php ENDPATH**/ ?>