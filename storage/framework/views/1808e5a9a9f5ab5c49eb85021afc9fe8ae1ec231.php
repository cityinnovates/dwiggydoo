					    ...
					    <div class="form-group col-lg-4 col-md-6 mb-4">
						    ...
						    <select class="form-control" id="Breeds" name="breeds">
							    <option value="any">Any</option>
							     <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($breed->id); ?>" <?=@$_GET['breeds'] == $breed->id? 'selected':'';?>><?php echo e($breed->name); ?></option>
					    ...
					    <div class="form-group col-lg-4 col-md-6 mb-4">
						    ...
						    <option value="any">Any</option>
							    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($category->id); ?>" <?=@$_GET['goodgenes'] == $category->id? 'selected':'';?>><?php echo e($category->getTranslation('name')); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						    </select>
					    </div>
					  </div>
						...
						<div class="row d-flex align-items-center">
								...
								<div class="dd_know_lft">
									<div class="row d-flex align-items-center">
										<div class="col-lg-4 mb-2">
											<div class="dd_know_img"><img src="<?php echo e($products->file_path); ?>" class="bdr-rdius24"></div>
										</div>
										<div class="col-lg-8">
							...
							<div class="col-md-7 mb-4">
								<div class="dd_form_btn text-center">
								  	<a href="https://dwiggydoo.com/confirm-request/<?php echo e($value->id); ?>" style="    background: white;"><button type="submit" class="btn mr-md-2 mb-4 f-medium bg-f3 color-fff">Confirm</button></a>
								  	<a href="https://dwiggydoo.com/remove-request/<?php echo e($value->id); ?>" style="    background: white;"><button style="background: transparent !important;" type="submit" class="btn bg-trsprnt color-f3 ml-md-2 mb-4 f-medium">Remove</button></a>
								  </div>
							</div>
						</div>
						<?php  }   ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/frontend/all-request.blade.php ENDPATH**/ ?>