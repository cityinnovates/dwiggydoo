...
<div class="row">
		            ...
		            <tbody>
		                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                    <tr>
		                        ...
		                        <td class="text-right">
		                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="<?php echo e(route('ecom_brands.edit', ['id'=>$brand->id, 'lang'=>env('DEFAULT_LANGUAGE')] )); ?>" title="<?php echo e(translate('Edit')); ?>">
		                                <i class="las la-edit"></i>
		                            </a>
		                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="<?php echo e(route('ecom_brands.destroy', $brand->id)); ?>" title="<?php echo e(translate('Delete')); ?>">
	...
	<div class="col-md-5">
		<div class="card">
			...
			<div class="card-body">
				<form action="<?php echo e(route('ecom_brands.store')); ?>" method="POST">
					<?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/backend/ecom_product/brands/index.blade.php ENDPATH**/ ?>