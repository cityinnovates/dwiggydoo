...
<div class="aiz-titlebar text-left mt-2 mb-3">
	...
	<div class="row align-items-center">
		...
		<div class="col-md-6">
			...
			<h1 class="h3"><?php echo e(translate('All Genes')); ?></h1>
		...
		<div class="col-md-6 text-md-right">
			...
			<a href="<?php echo e(route('categories.create')); ?>" class="btn btn-primary">
				...
				<span><?php echo e(translate('Add New Genes')); ?></span>
...
<div class="card">
    ...
    <div class="card-header">
        ...
        <h5 class="mb-0 h6"><?php echo e(translate('Genes')); ?></h5>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/backend/product/categories/index.blade.php ENDPATH**/ ?>