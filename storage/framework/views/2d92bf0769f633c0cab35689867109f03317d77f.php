...
<section>
	<div class="container">
		<div class="row" style="margin: 10px;">
			<div class="col" >
				<img src="<?php echo e(Auth::user()->avatar_original); ?>" style="width: 80px;">
				<p><b><?php echo e(Auth::user()->name); ?></b></p>
			</div>
			<div class="col">
				<div style="float: right;" >
					<button  style=" background-color: #F3735F; color: white; border-radius: 25px; border: none;" type="submit" class="btn btn-primary"><?php echo e(@$ProfessionCategory->name); ?></button>
				</div>
			</div>
		</div>
		<div style="width:100%">
	...
	<div class="container"><br>
		<div class="row" style="background-color: #000;">
			<div class="col-8" style="margin: 15px;">
				<h1 style="color: white;"><b><?php echo e(@$ProfessionCategory->name); ?></b></h1>
			...
			<div class="col">
				<img src="<?php echo e(uploaded_asset(@$profession->photo)); ?>">
			</div>
		</div>
	</div>
</section>
					...
					<div class="bl_Convers bl_Convers_bdr">
						<div class="row align-items-center">
									...
									<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
										...
										<div class="carousel-inner" data-toggle="modal" data-target="#ModalMyConnection2" style="    width: 155%;">
											<div class="carousel-item active">
												<img src="<?php echo e($users->avatar_original); ?>" style="height: 200px;" class="img-fluid">

											</div>
										</div>
									</div>
									<div class="bl_Convers_heart <?= !empty($wishlist->id)? 'active': ''; ?>" onclick="wishlist_items(<?php echo e(Auth::user()->id); ?>, <?php echo e($product->id); ?>);">
							...
							<div class="col-md-12 py-4 px-5">
								<div class="row">
									<div class="col"><p><b>Owner Name:<?php echo e($users->name); ?></b><br>
										Location: <?php echo e($location_id->name); ?><br> </p></div>
										<div class="col"><p><b>Profession:</b> <?php echo e($product->name); ?><br>
											<b>Age</b>:<?php echo e($product->age); ?>
								...
								<?php	
									...
									<a> <button value="<?php echo e($product->id); ?>" style="background-color: #f3735f; border: none; color: white;" type="submit" class="btn btn-primary">
									...
									<?php } else if($requests>0) {   ?>
										...
										<a><button value="<?php echo e($product->id); ?>" style="background-color: #5f86f3; border: none; color: white;" type="submit" class="btn btn-primary">
										<svg class="svg-inline--fa fa-user-plus mr-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
											<path fill="currentColor" d="M224 256c70.7 0 128-57.31 128-128S294.7 0 224 0C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3C77.61 304 0 381.6 0 477.3C0 496.5 15.52 512 34.66 512h378.7C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304zM616 200h-48v-48C568 138.8 557.3 128 544 128s-24 10.75-24 24v48h-48C458.8 200 448 210.8 448 224s10.75 24 24 24h48v48C520 309.3 530.8 320 544 320s24-10.75 24-24v-48h48C629.3 248 640 237.3 640 224S629.3 200 616 200z"></path>
										</svg> Request Sent
									</button></a>
									...
									<?php  } else { $brddd=@$_GET['breed']; ?>
								  	...
								  	<a <?php if(isset(Auth::user()->id)){?> href="https://dwiggydoo.com/send_requests/<?php echo e($product->id); ?>?breed=<?php echo e($brddd); ?>"  <?php  } else {  ?> data-toggle="modal" data-target="#staticBackdrop" <?php  }  ?>  ><button value="<?php echo e($product->id); ?>" style="background-color: #f3735f; border: none; color: white;" type="submit" class="btn btn-primary">
										<svg class="svg-inline--fa fa-user-plus mr-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
											<path fill="currentColor" d="M224 256c70.7 0 128-57.31 128-128S294.7 0 224 0C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3C77.61 304 0 381.6 0 477.3C0 496.5 15.52 512 34.66 512h378.7C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304zM616 200h-48v-48C568 138.8 557.3 128 544 128s-24 10.75-24 24v48h-48C458.8 200 448 210.8 448 224s10.75 24 24 24h48v48C520 309.3 530.8 320 544 320s24-10.75 24-24v-48h48C629.3 248 640 237.3 640 224S629.3 200 616 200z"></path>
										</svg> Send Request
									</button></a>
...
<div class="container">
	...
	<img src="<?php echo e(uploaded_asset($ProfessionCategory->photo)); ?>">
</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-12 mb-5 mt-4">
				...
				<p class="f-20 f-reg color-27 mb-4 text-center"><?php echo e(json_decode($ProfessionCategory->testimonial_content, true)[1]); ?></p>
		...
		<div class="row">
			<div class="col-12 text-center">
				<div class="prf_otm2 text-center" style="    margin-top: -12%;">
					...
					<img src="<?php echo e(uploaded_asset(json_decode($ProfessionCategory->testimonial_photo, true)[1])); ?>" class="img-fluid mb-4">
					<h4 class="f-bold f-30 color-27"><?php echo e(json_decode($ProfessionCategory->testimonial_name, true)[1]); ?></h4>
				</div>
			</div>
		</div>
	</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/frontend/profession.blade.php ENDPATH**/ ?>