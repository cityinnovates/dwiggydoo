  ...
  if (event.keyCode === 13) {
   event.preventDefault();
    ...
    var id=$('#id').val();
	  $.ajax({
            type:'POST',
            url:'<?php echo e(env('APP_URL')); ?>/hsubmitcomm',
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/frontend/human_advice.blade.php ENDPATH**/ ?>