...
<div class="card">
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<input type="text" class="form-control" placeholder="Title" name="title" value="<?php echo e($page->getTranslation('title',$lang)); ?>" required>
	...
	<div class="form-group row">
				...
				<label class="col-sm-2 col-from-label" for="name"><?php echo e(translate('Description')); ?> <span class="text-danger">*</span> <i class="las la-language text-danger" title="<?php echo e(translate('Translatable')); ?>"></i></label>

				<div class="col-sm-10">

					<input type="text" class="form-control" placeholder="Description" name="description" value="<?php echo e($page->description); ?>" required>
					...
					<div class="col-sm-10">
						...
						<div class="input-group">
							...
							<?php if($page->type == 'custom_page'): ?>
								...
								<div class="input-group-prepend"><span class="input-group-text"><?php echo e(route('home')); ?>/</span></div>

								<input type="text" class="form-control" placeholder="<?php echo e(translate('Slug')); ?>" name="slug" value="<?php echo e($page->slug); ?>">

							<?php else: ?>

								<input class="form-control" value="<?php echo e(route('home')); ?>/<?php echo e($page->slug); ?>" disabled>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/backend/website_settings/pages/edit.blade.php ENDPATH**/ ?>