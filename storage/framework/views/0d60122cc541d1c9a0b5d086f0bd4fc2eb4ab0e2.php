...
<div class="col-md-12 mx-auto">
	<form class="form form-horizontal mar-top" action="<?php echo e(route('ecom_products.store')); ?>" method="POST" enctype="multipart/form-data" id="choice_form">
		<?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/backend/ecom_product/products/create.blade.php ENDPATH**/ ?>