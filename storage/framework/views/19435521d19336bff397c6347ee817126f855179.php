                    ...
                    <div class="tab-content">
                        <div class="tab-pane p-3 active" id="cplan" role="tabpanel">
                            <div class="row">
                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-4">
                                         <div class="card">
                                            ...
                                            <div class="card-body">
                                                <table class="w-100">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><del><?php echo e($row2->pr_orginal); ?></del></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Offer Price</strong></td>
                                                        <td><?php echo e($row2->pr_offer); ?></td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <div class="card-footer text-muted  <?php if($i == 1 || $i == 4 ) {echo 'alert-info';}elseif($i == 2 || $i == 5 ) { echo 'alert-warning'; } else{ echo 'alert-success'; } ?>">
                                                <a href="<?php echo e(route('plan.plans_edit',$row2->pr_id )); ?>" class="btn btn-warning btn-sm waves-effect waves-light"> Edit </a> <a href="<?php echo e(route('plan.plans_destory', $row2->pr_id )); ?>" class="btn btn-danger btn-sm waves-effect waves-light" onclick="return confirm('Are You Sure To Delete This Record');"> Delete</a>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function change_status(ids, values){
        ajax_update_status('post', '<?php echo e(route("plan.plans_cstatus")); ?>', values, ids, '<?php echo e(route("plan.plans")); ?>', 'Sorry! failed update.', 'Successfully updated.');
    }
    ...
    $.ajax({
       type: type,
       url: url,
       data: {"_token": "<?php echo e(csrf_token()); ?>", "status" : values, "id" : ids},
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="background: #f4f5f6;">
            ...
            <div class="modal-body" >
                ...
                <form class="row needs-validation" method="post" action="<?php echo e(route('plan.plans_add_ajax')); ?>" enctype="multipart/form-data" novalidate>
                     <?php echo csrf_field(); ?>
                     <div class="row">
                         <div class="col-md-12">
...
<!-- /.modal --> 
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/backend/plans/index.blade.php ENDPATH**/ ?>