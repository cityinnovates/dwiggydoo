...
<section class="pt-5">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12"><img src="<?php echo e(uploaded_asset($value->banner_image)); ?>" class="img-fluid"></div>
			<div class="col-md-12">
...
<section class="pb-5 bg-lgray pt-5">
	<div class="container">
		...
		<div class="dwiggy-form" >
			...
			<?php echo csrf_field(); ?>
			<input type="hidden" id="current" name="current"  value="<?php echo e(URL::current()); ?>">
			<div class="form-row">
	...
	<div class="container">
		...
		<div class="row">
			<?php  foreach ($blogsss as $key => $value) {  ?>
				<div class="col-4">
					<div class="card-deck">
						<a href="https://dwiggydoo.com/blogsdetails/<?php echo e($value->id); ?>">
							<div class="card">
								<img src="<?php echo e(uploaded_asset($value->banner_image)); ?>" class="card-img-top" alt="...">
								<div class="card-body">
...
function submit(){
    ...
    var current=$('#current').val();
	  $.ajax({
            type:'POST',
            url:'<?php echo e(env('APP_URL')); ?>/hsubmitsugg',
            data: {"comment":comment,"email":email,"name":name,"mobile":mobile,"current":current,"_token": "<?php echo e(csrf_token()); ?>"},
...
function doSomething() {
    ...
    var reward=5;
     $.ajax({
            type:'POST',
            url:'<?php echo e(env('APP_URL')); ?>/rewardblog',
            data: {"uid":<?=@$uid?>,"reward":reward,"bid":<?=$id?>,"_token": "<?php echo e(csrf_token()); ?>"},
            success:function(data) {
            $('#sb1').hide();
            $('#sb2').show();
               $('#sub').show();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/frontend/blogsdetails.blade.php ENDPATH**/ ?>