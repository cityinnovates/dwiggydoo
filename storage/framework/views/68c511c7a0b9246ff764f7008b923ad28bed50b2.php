...
<div class="aiz-titlebar text-left mt-2 mb-3">
	...
	<div class="row align-items-center">
		...
		<div class="col">
			...
			<h1 class="h3"><?php echo e(translate('Add New Blog Slider')); ?></h1>
...
<div class="card">
	...
	<form action="<?php echo e(route('custom-pages.blogstoreslider')); ?>" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/backend/website_settings/pages/blogcreateslider.blade.php ENDPATH**/ ?>