    ...
    <div class="page-page">
        ...
        <div> 
            ...
            <div class="page-fullWidthComponent">
                ...
                <div class="rewardpp">
                    <h1 style="" class=" justify-content-center formik">  <i class="fa-solid fa-coins"></i> <?php echo e($total_cr); ?><br><span style="font-size: 20px;">REDEEMABLE  POINTS</span></h1>
                    <div class="row">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/outstand/public_html/dwiggydoo/resources/views/frontend/user/customer/notification.blade.php ENDPATH**/ ?>