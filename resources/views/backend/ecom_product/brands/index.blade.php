...
<div class="row">
		            ...
		            <tbody>
		                @foreach($brands as $key => $brand)
		                    <tr>
		                        ...
		                        <td class="text-right">
		                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('ecom_brands.edit', ['id'=>$brand->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
		                                <i class="las la-edit"></i>
		                            </a>
		                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('ecom_brands.destroy', $brand->id)}}" title="{{ translate('Delete') }}">
	...
	<div class="col-md-5">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('ecom_brands.store') }}" method="POST">
					@csrf
