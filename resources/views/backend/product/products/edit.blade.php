...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h1 class="mb-0 h6">{{ translate('Edit Dog') }}</h5>
</div>
		...
		<div class="card">       
			<div class="card-body">
				<div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Dog Name')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-lg-8">
                ...
                <div class="form-group row" id="brand">
                    <label class="col-lg-3 col-from-label">{{translate('Breed')}}</label>
                    <div class="col-lg-8">
                        ...
                        <select class="form-control aiz-selectpicker" name="brand_id" id="brand_id">
							...
							@foreach($attributes as $breeds)
								<option  <?php if($product->brand_id == $breeds->id){ echo  "selected";  }?> value="{{ $breeds->id }}">{{ $breeds->name}}</option>
							@endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Gender')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i> </label>
                    <div class="col-lg-8">


                         <select class="form-control aiz-selectpicker" name="unit"  data-live-search="true" required="">
							<option value="">{{ ('Select Gender') }}</option>
								<option   <?php if($product->unit == '0'){ echo  "selected";  }?> value="0">Male</option>
								<option   <?php if($product->unit == '1'){echo  "selected";  }?>  value="1">Female</option>
              ...
              <div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Location')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i> </label>
                    <div class="col-lg-8">


                         <select class="form-control aiz-selectpicker" name="location_id"  data-live-search="true" required="">
							<option value="">{{ ('Select Location') }}</option>
								@foreach($city as $city)
								<option  <?php if($product->location_id == $city->id){ echo  "selected";  }?> value="{{ $city->id }}">{{ $city->name}}</option>
							@endforeach
						</select>
                    </div>
                </div>
