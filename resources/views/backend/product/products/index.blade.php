...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		<div class="col-md-6">
			<h1 class="h3">{{translate('All Dog Listing')}}</h1>
		</div>
        @if($type != 'Seller')

    		<!-- <div class="col-md-6 text-md-right">
    			<a href="{{ route('products.create') }}" class="btn btn-circle btn-info">
    				<span>{{translate('Add New Dog')}}</span>
    			</a>
    		</div> -->
        @endif
	</div>
...
<div class="card">
  ...
  <div class="modal fade" id="myModaluser" role="dialog">
    ...
    <?php   if($product->file_path!=''){ 
                        ...
                        <img src="{{$product->file_path}}"   alt="Image" class="w-50px" width="100"  height="100">
                                                <?php  } else {   ?>
                           <video controls width="100"  height="100">
                           <source src="{{$product->file_path}}" type="video/mp4"  alt="Image" class="w-50px" width="100"  height="100">
