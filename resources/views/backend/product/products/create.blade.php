...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{translate('Add New Dog')}}</h5>
</div>
	...
	<form class="form form-horizontal mar-top" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
		...
		<div class="card">
			...
			<div class="card-header">
				...
				<h5 class="mb-0 h6">{{translate('Dog Information')}}</h5>
			...
			<div class="card-body">
				...
				<div class="form-group row">
					...
					<label class="col-md-3 col-from-label">{{translate('Dog Name')}} <span class="text-danger">*</span></label>
				...
				<div class="form-group row" id="brand">
					...
					<label class="col-md-3 col-from-label">{{translate('Breed')}}</label>
				...
				<div class="form-group row">
					...
					<label class="col-md-3 col-from-label">{{translate('Gender')}}</label>
