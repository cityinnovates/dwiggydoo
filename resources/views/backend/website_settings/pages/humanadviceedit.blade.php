...
<div class="aiz-titlebar text-left mt-2 mb-3">
	...
	<div class="row align-items-center">
		...
		<div class="col">
			...
			<h1 class="h3">{{ translate('Edit Human Advice Page Information') }}</h1>
...
<div class="card">
	...
	<form class="p-4" action="{{ route('custom-pages.humanadviceupdate', $page->id) }}" method="POST" enctype="multipart/form-data">
