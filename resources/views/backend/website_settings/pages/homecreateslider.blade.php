...
<div class="aiz-titlebar text-left mt-2 mb-3">
	...
	<div class="row align-items-center">
		...
		<div class="col">
			...
			<h1 class="h3">{{ translate('Add New Home Slider') }}</h1>
...
<div class="card">
	...
	<form action="{{ route('custom-pages.homestoreslider') }}" method="POST" enctype="multipart/form-data">
		...
		<div class="card-body">
			...
			<div class="form-group row">
					...
					<label class="col-sm-2 col-from-label" for="name">{{translate('Video Banner')}}</label>
