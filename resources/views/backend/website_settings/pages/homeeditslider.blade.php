...
<div class="aiz-titlebar text-left mt-2 mb-3">
	...
	<div class="row align-items-center">
		...
		<div class="col">
			...
			<h1 class="h3">{{ translate('Edit Home slider Information') }}</h1>
...
<div class="card">
	...
	<form class="p-4" action="{{ route('custom-pages.homeupdateslider', $page->id) }}" method="POST" enctype="multipart/form-data">
	  ...
	  <h6 class="fw-600 mb-0">Home slider Content</h6>
		...
		<div class="form-group row">
				...
				<label class="col-sm-2 col-from-label" for="name">{{translate('Home Image')}}</label>
		...
		<div class="form-group row">
				...
				<label class="col-sm-2 col-from-label" for="name">{{translate('Video')}}</label>
				...
				<div class="col-sm-10">
					...
					<div class="input-group " data-toggle="aizuploader" data-type="video">
							...
							<input type="hidden" name="banner_video" class="selected-files" value="{{ $page->banner_video }}">
			...
			<div class="form-group row">
				...
				<label class="col-sm-2 col-from-label" for="name">{{translate('Button Link')}}</label>

				<div class="col-sm-10">

					<input type="text" class="form-control" placeholder="Button Link https://xyz.com/..." name="link" value="{{ $page->link }}">
