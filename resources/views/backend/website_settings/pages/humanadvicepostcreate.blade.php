...
<div class="aiz-titlebar text-left mt-2 mb-3">
	...
	<div class="row align-items-center">
		...
		<div class="col">
			...
			<h1 class="h3">{{ translate('Add New Human Advice Post') }}</h1>
...
<div class="card">
	...
	<form action="{{ route('custom-pages.humanadvicepoststore') }}" method="POST" enctype="multipart/form-data">

		@csrf

		<div class="card-header">

			<h6 class="fw-600 mb-0">{{ translate('Human Advice Page Content') }}</h6>
