		...
		<div class="row gutters-10">
			...
			<div class="col-lg-6">
				...
				<div class="card shadow-none bg-light">
					...
					>{{ json_decode(get_setting('home_slider_text2'), true)[$key] }}</textarea>
			...
			<div class="col-lg-6">
				...
				<div class="card shadow-none bg-light">
					...
					>{{ json_decode(get_setting('home_banner1_text2'), true)[$key] }}</textarea>
			...
			<div class="col-lg-6">
				...
				<div class="card shadow-none bg-light">
					...
					<div class="card-header">
						...
						<h6 class="mb-0">{{ translate('Home Memes  (Max 3)') }}</h6>
			...
			<div class="col-lg-6">
				...
				<div class="card shadow-none bg-light">
					...
					<div class="card-header">
						...
						<h6 class="mb-0">{{ translate('World Banner') }}</h6>
											...
											<div class="row gutters-5">
												<div class="col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="home_world_section_heading" value="{{ get_setting('home_world_section_heading') }}" placeholder="Heading">
													</div>
												</div>
												<div class="col-12">
													<div class="form-group">
														<input type="hidden" name="types[]" value="home_world_section_button_link">
														<input type="text"  class="form-control" name="home_world_section_button_link" value="{{ get_setting('home_world_section_button_link') }}" placeholder="Link">
													</div>
												</div>
												<div class="col-12">
													<div class="input-group" data-toggle="aizuploader" data-type="image">
						                                ...
						                                <input type="hidden" name="home_world_section_background[]" class="selected-files" value="{{ json_decode(get_setting('home_world_section_background'), true)[0] }}">
												...
												<div class="col-12">
													...
													<textarea class="aiz-text-editor form-control" data-buttons='[["font", ["bold", "underline", "italic", "clear"]],["para", ["ul", "ol", "paragraph"]],["style", ["style"]],["color", ["color"]],["table", ["table"]],["insert", ["link", "picture", "video"]],["view", ["fullscreen", "codeview", "undo", "redo"]]]' placeholder="Content.." data-min-height="300" name="home_world_section_content[]">{{ json_decode(get_setting('home_world_section_content'), true)[0] }}</textarea>
												</div>
											</div>
									@endif
								</div>
			...
			<div class="col-lg-6">
				...
				<div class="card shadow-none bg-light">
					...
					<div class="card-header">
						...
						<h6 class="mb-0">{{ translate('About Section What') }}</h6>
											...
											<div class="row gutters-5">
												<div class="col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="home_about_section_heading" value="{{ get_setting('home_about_section_heading') }}" placeholder="Heading">
													</div>
												</div>
												<div class="col-12">
													<div class="form-group">
														<input type="hidden" name="types[]" value="home_about_section_button_link">
														<input type="text"  class="form-control" name="home_about_section_button_link" value="{{ get_setting('home_about_section_button_link') }}" placeholder="Link">
													</div>
												</div>
												<div class="col-12">
													<div class="input-group" data-toggle="aizuploader" data-type="image">
						                                ...
						                                <input type="hidden" name="home_about_section_image[]" class="selected-files" value="{{ json_decode(get_setting('home_about_section_image'), true)[0] }}">
			...
			<div class="col-lg-6">
				...
				<div class="card shadow-none bg-light">
					...
					<div class="card-header">
						...
						<h6 class="mb-0">{{ translate('About Section Why') }}</h6>
											...
											<div class="row gutters-5">
												<div class="col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="home_about_section_heading_why" value="{{ get_setting('home_about_section_heading_why') }}" placeholder="Heading">
													</div>
												</div>
												<div class="col-12">
													<div class="form-group">
														<input type="hidden" name="types[]" value="home_about_section_button_link_why">
														<input type="text"  class="form-control" name="home_about_section_button_link_why" value="{{ get_setting('home_about_section_button_link_why') }}" placeholder="Link">
													</div>
												</div>
												<div class="col-12">
													<div class="input-group" data-toggle="aizuploader" data-type="image">
						                                ...
						                                <input type="hidden" name="home_about_section_image_why[]" class="selected-files" value="{{ json_decode(get_setting('home_about_section_image_why'), true)[0] }}">
			...
			<div class="col-lg-6">
				...
				<div class="card shadow-none bg-light">
					...
					<div class="card-header">
						...
						<h6 class="mb-0">{{ translate('About Section Rewards') }}</h6>
											...
											<div class="row gutters-5">
												<div class="col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="home_about_section_heading_rewards" value="{{ get_setting('home_about_section_heading_rewards') }}" placeholder="Heading">
													</div>
												</div>
												<div class="col-12">
													<div class="form-group">
														<input type="hidden" name="types[]" value="home_about_section_button_link_rewards">
														<input type="text"  class="form-control" name="home_about_section_button_link_rewards" value="{{ get_setting('home_about_section_button_link_rewards') }}" placeholder="Link">
													</div>
												</div>
												<div class="col-12">
													<div class="input-group" data-toggle="aizuploader" data-type="image">
						                                ...
						                                <input type="hidden" name="home_about_section_image_rewards[]" class="selected-files" value="{{ json_decode(get_setting('home_about_section_image_rewards'), true)[0] }}">
												...
												<div class="col-12">
													...
													<textarea class="aiz-text-editor form-control" data-buttons='[["font", ["bold", "underline", "italic", "clear"]],["para", ["ul", "ol", "paragraph"]],["style", ["style"]],["color", ["color"]],["table", ["table"]],["insert", ["link", "picture", "video"]],["view", ["fullscreen", "codeview", "undo", "redo"]]]' placeholder="Content.." data-min-height="300" name="home_about_section_content_rewards[]">{{ json_decode(get_setting('home_about_section_content_rewards'), true)[0] }}</textarea>
												</div>
											</div>
									@endif
								</div>
			...
			<div class="col-lg-6">
				<div class="card shadow-none bg-light">
					<div class="card-header">
						<h6 class="mb-0">{{ translate('Footer Images') }}</h6>
					</div>
					<div class="card-body">
						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
							@csrf
											...
											<div class="row gutters-5">
												<div class="col-10">
													<div class="input-group" data-toggle="aizuploader" data-type="image">
						                                ...
						                                <input type="hidden" name="home_footer_images" class="selected-files" value="{{ json_decode(get_setting('home_footer_images'), true)[$key] }}">
						                            </div>
						                            <div class="file-preview box sm">
						                            </div>
												</div>
