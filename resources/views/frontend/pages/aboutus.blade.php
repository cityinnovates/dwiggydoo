...
<section class="banner about_us">
	<div class="container-fluid pr-0 pl-0">
		<div class="banner-index index-1" style="background: url({{ static_asset($file_name) }})">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="banner-cnt">
							<h1 class="head-cnt f-40 f-bold color-27 mb-4">{{$about->title}}</h1>
...
<section class="py-md-5 mb-5">
	<div class="container">
		...
		<div class="row">
			<div class="col">
				<div class="row" >
					<div class="col" ><img class="fourdog" src="{{ uploaded_asset(get_setting('about_me_small_image1')) }}"  /></div>
					<div class="col"><img src="{{ uploaded_asset(get_setting('about_me_small_image2')) }}" style="background-color: #EAEAEA; border-radius: 100px;" /></div>
					<div class="col"><img src="{{ uploaded_asset(get_setting('about_me_small_image3')) }}"  style="background-color: #EAEAEA; border-radius: 100px;"/></div>
					<div class="col"><img class="fourdog" src="{{ uploaded_asset(get_setting('about_me_small_image4')) }}" 	 /></div>

				</div>
				<img src="{{ uploaded_asset(get_setting('about_me_big_image')) }}" class="path-523"/>
		...
		@if (get_setting('about_slider_images') != null)
			...
			@foreach (json_decode(get_setting('about_slider_images'), true) as $key => $value)
				...
				<div class="row">
					...
					<div class="column">
						<img src="{{ uploaded_asset(json_decode(get_setting('about_slider_images'), true)[$key]) }}" >
					</div>
				</div>
				@else
				...
				<div class="row">
					<div class="column" >
						<img  src="{{ uploaded_asset(json_decode(get_setting('about_slider_images'), true)[$key]) }}" style="width: 101%" >
					</div>
					<div class="column bgforab" style="background: url({{ static_asset('uploads/all/SjFCUviQJ4BP0Cfq9olI1rOljpGbGCgHzqzYJp5u.png') }});background-color: #F3735F;">
						<div class="f-16 f-medium" style="color: white; margin: 25px;">
							<?= htmlspecialchars_decode($dec) ?>
						</div>
					</div>
	...
	<div class="container">
		<div class="dd_middle d-flex w-100 justify-content-between">
			<div class="dd_middle_box d-flex align-items-center mr-md-5 mb-5">
				<div class="dd_middle_img mr-md-4"><img src="{{ static_asset('uploads/all/7lgloUSdsQQIlebXHRLn4tsXcfLPaUKhDxcxQ8XO.png') }}"></div>
			...
			<div class="dd_middle_box d-flex align-items-center mr-lg-5 mb-5">
				<div class="dd_middle_img mr-md-4"><img src="{{ static_asset('uploads/all/2QboVORbSGwC4QQGMmXbybV8fbNa0wYY1XmqkSEY.png') }}"></div>
				<div class="dd_middle_cnt">
...
<section class="pb-5 pt-4 mb-5">
	<div class="container">
		<div class="dd_bgimg bdr-rdius24 about_reg pos-rel" style="background: url({{ static_asset('uploads/all/bQADlz3mq3ooQjMklfCqcm8CzvOgQeEj3NEOHn4F.png') }})">
			...
			<div class="about_pos"><img src="{{ static_asset('uploads/all/FKgHc8i35lLAuVW65HDf88YdFgsZGuArdnYODdVA.png') }}"></div>
		</div>
	</div>
</section>
