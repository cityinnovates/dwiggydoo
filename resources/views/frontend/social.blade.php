  ...
  if (event.keyCode === 13) {
   event.preventDefault();
    ...
    var id=$('#id').val();
	  $.ajax({
            type:'POST',
            url:'{{env('APP_URL')}}/hsubmitconcern',
            data: {"concern":comment,"id": id,"_token": "{{ csrf_token() }}"},
	...
	<div class="container">
		<div class="row">
			<div class="col-12 mb-5 mt-4">
				<h1 class="f-bold dd_heading f-40 color-27 text-center breed-ctn pos-rel mb-5">{{$social->title}}
					</h1>
