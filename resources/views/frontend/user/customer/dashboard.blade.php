            ...
            <div class="page-fullWidthComponent">
                   <div class="dashboard-data">
                    ...
                    <table class="dashboard-squareContainer">
                        <tr>
                            <td><a class="link-card" href="{{ route('dog.account') }}">
                            ...
                            <td><a class="link-card" href="{{ route('user.connections_list') }}">
                            ...
                            <td><a class="link-card" href="{{ route('user.address') }}">
                        ...
                        <tr style="margin: 0px; padding: 0px;">
                            ...
                            <td><a class="link-card" href="{{ route('notification') }}">
                            ...
                            <td style="width: 20px;"><a class="link-card" href="{{ route('user.privacy_policy') }}">
...
@if(Session::get('thank_you_popup_after_login') == null)
<div class="pp_after">
    <div class="pp_after_body">
        <button type="button" class="close go_ahead" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
        <div class="pp_after_img"><img src="{{ route('home') }}/images/thank-you-popup-images.png" class="img-fluid"></div>
