    ...
    <div class="page-page">
        ...
        <div> 
            ...
            <div class="page-fullWidthComponent">
                ...
                <div class="rewardpp">
                    <h1 style="color: #58bed7; font-size: 30px; text-align: center;" class=" justify-content-center">  <i class="fa-solid fa-coins  "></i> {{ $total_cr }}<br><span style="font-size: 20px;">REDEEMABLE  POINTS</span></h1>
                    <div class="row">
