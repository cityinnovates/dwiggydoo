            ...
            <div class="page-fullWidthComponent">
              <br>
                        ...
                        <div class=" d-flex " style="float: right;">
                            ...
                            <form id="filter-form" method="get" action=""> 
                                <select class="form-control srch-form px-4 bdr-rdius24 gotham-book" style="margin-top: -10px;" name="sort_by" onchange="filter()">
                                    ...
                                    <option value="block" @isset($sort_by) @if ($sort_by == 'block') selected @endif @endisset>{{ translate('Blocked list')}}</option>
                                </select>
                            </form>
                        </div>
                    </div>
                ...
                <div class="row ">
                    <div class="col">
                        <div>
                            ...
                            <img src="{{ $value->file_path }}" class='iconDetails'>    
                            ...
                            <img src="{{ uploaded_asset($value->thumbnail_img) }}" class='iconDetails'>
                            <?php  }   ?>
                        </div>
                        <div style='margin-left:100px; margin-top: 10px;'>
                            <p><b>{{ @$value->name.$value->id}}</b> <img src="<?= $owner_profile->avatar_original != null ? $owner_profile->avatar_original : route('home').'/images/beagle.png';?>" style="height: 22px;width: 22px;border-radius: 50px;"> </p>
                            <div style="font-size:10px;">Breed: <b>{{ optional($breed)->name }}</b> | Cat: <b>{{ optional($categories)->name }}</b> | <b><?php if($value->unit==0){ echo "Male"; }else { echo "Female"; } ?></b> | <b>{{ optional($location_id)->name }}</b></div>
                 ...
                 <?php } ?>
                 <div class="row">
                      <div class="col-12"><div class="float-right">{{ $product1->links() }}</div></div>
                 </div>
                ...
                <?php }else{ ?>
                    ...
                    <div class="row">
                        ...
                        <div class="text-center mb-4 f-Montserrat" style="font-family: 'Pacifico', cursive; font-size: 81px; color: black;">Oh Oh !</div>
                            <div class="text-center mb-4"><img src="{{ route('home') }}/images/shutterstock_1610553859-removebg-preview.png" class="img-fluid"></div>
                ...
                <div class="row" style="margin: 20px;">
                    ...
                    <div class="col"><a href="{{ url('https://dwiggydoo.com/all-connections') }}" style="float: right;"><b>See All</b></a></div>
                </div>
                <div class="row">
                    <?php 
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <?php
                                        ...
                                        <img style="width: 100%;height: 200px;object-fit: cover;" src="{{$products->file_path}}">
                                    ...
                                    <div class="bl_Convers_cnt items_<?= $key ?>">
                                        ...
                                        <div class="bl_Convers_chat mt-3">
                                            ...
                                            <?php } else { ?> 
                                                ...
                                                <a <?php if(@isset(Auth::user()->id)){?> href="https://dwiggydoo.com/send_request/{{$products->id}}"  <?php  } else {  ?> data-toggle="modal" data-target="#staticBackdrop" <?php  }  ?>>   <button type="button" class="btn btn-primary"><i class="fas fa-user-plus"></i> Send Request</button></a>      
