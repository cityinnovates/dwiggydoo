...
<section class="banner">
	<div class="container-fluid pr-0 pl-0">
		<div class="owl-carousel owl-theme">
			...
			<div class="banner-index index-1 achive" style="background-size: cover!important;background: url({{ uploaded_asset($value->banner_image) }}) center 0 no-repeat;">
				<div class="container">
					<div class="row ">
						<div class="col-lg-7">
	...
	<div class="container">
		<div class="row">
				...
				<?php  foreach ($blogs as $key => $value) {  ?>
					<div class="col-4">
					   <a href="https://dwiggydoo.com/blogsdetails/{{$value->id}}"> <img src="{{ uploaded_asset($value->banner_image) }}" class="card-img-top img-fluid" alt="<?=ucwords($value->title)?>"></a>
					    <div class="card-body">
