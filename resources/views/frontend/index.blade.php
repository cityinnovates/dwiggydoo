<!--<center><img style="margin-top:150px;" src="{{ route('home') }}/images/underconstruction.png"></center>-->
...
<header class="header2">
  ...
  <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
    <source src="{{ uploaded_asset($slider_data[0]->banner_video)  }}" type="video/mp4">
    </video>
...
@include('frontend.partials.effort-bar')
@include('frontend.partials.score_table')
@include('frontend.partials.score_missing_table')
  ...
  <div class="container">
    ...
    <div class="breed_sec pos-rel">
      <div class="dd_centre_div">
        <div class="dwiggy_cntr"><img src="{{ route('home') }}/images/dwiggy_cntr.png" class="img-fluid"></div>
        <div class="dd_arrow1"><img src="{{ route('home') }}/images/arrow1.png" class="img-fluid"></div>
        <div class="dd_arrow2"><img src="{{ route('home') }}/images/arrow2.png" class="img-fluid"></div>
        <div class="dd_arrow3"><img src="{{ route('home') }}/images/arrow3.png" class="img-fluid"></div>
        <div class="dd_arrow4"><img src="{{ route('home') }}/images/arrow4.png" class="img-fluid"></div>
      </div>
      <div class="row">
      ...
      <div class="col-12">
        <div class="dd_cnt_sec d-flex justify-content-between align-items-center w-100 pb-5">
          <h3 class="f-bold dd_heading f-25 color-27  breed-ctn pos-rel mb-0">Find them a connection
            <img src="{{ route('home') }}/images/new_xd_images/logo-4.png" class="img-fluid dd_img_pos">
          </h3>
          <div class="dd_search pos-rel">
            <a href="{{ route('connections.breed') }}">
              <p class="redtoblue" style=" font-size: 18px"><b>View all</b> <img src="{{ route('home') }}/images/Icon ionic-ios-arrow-round-back@2x.png" style="width: 20px;"></p>
            </a>
		...
		<div class="row">
          ...
          ?>
				  ...
				  <li class="nav-item mr-4 mb-4" role="presentation">
				    <a class="nav-link bdr-rdius24 color-f3 gothambold-f15" id="pills-profile-tab{{$value->id}}" data-toggle="pill" href="#pills-profile{{$value->id}}" role="tab" aria-controls="pills-profile{{$value->id}}" aria-selected="false">{{$value->name}}</a>
				  </li>
            ...
            ?>
						...
						<div class="col-lg-3 col-md-4 col-sm-6 mb-5">
							<a href="https://dwiggydoo.com/all-connections/?breed={{$value->name}}">
              ...
              <section class="no_match_found py-5">
              	<div class="container">
              		<div class="match_found text-center">
              			<div class="match_found_top"><img src="{{ route('home') }}/images/new_img/ohno.png" class="img-fluid"></div>
              			<div class="match_found_img"><img src="{{ route('home') }}/images/new_img/beagle-dog.png" class="img-fluid"></div>
...
<section>
  <div class="container">
    <img src="{{ route('home') }}/images/dwiggy_cntr.png" class="center">
    <br>
    <div class="row d-flex justify-content-center">
      @if (get_setting('home_about_section_heading') != null)
      ...
      @endif
      @if (get_setting('home_about_section_heading_why') != null)
      ...
      @endif
      @if (get_setting('home_about_section_heading_rewards') != null)
  ...
  <div class="container">
      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="dd_allCNT p-5">
            <h2 class="color-brown f-24 f-bold mb-4">{{ get_setting('home_about_section_heading') }}</h2>
              
              <?php echo htmlspecialchars_decode($str_word2); ?>
            <div class="Dwiggy_bnr_btn mb-5">
              <a class="dwiggy_btn bg-ff bdr-rdius24 bdr-none gothambold-f15 color-f3" style="color: white;" href="{{ get_setting('home_about_section_button_link') }}">Read More <img src="{{ route('home') }}/images/Icon ionic-ios-arrow-round-back@2x.png" style="width: 20px;"></a>
            </div>
          </div>
        </div>
        <div class="col">
          <div style="position: relative; left: 0; top: 0;">
            <img src="{{ route('home') }}/images/Rectangle 2924.png" class="borderr" />
            <img src="{{ uploaded_asset(json_decode(get_setting('home_about_section_image'), true)[0]) }}" class="girlwithpuppy" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="ddassa2">
      <div class="row">
        <div class="col-lg-7">
          <div class="dd_allCNT p-5">
            <h2 class="color-brown f-24 f-bold mb-4">{{ get_setting('home_about_section_heading_why') }}</h2>
              
              <?php echo htmlspecialchars_decode($str_word3); ?>

            <div class="Dwiggy_bnr_btn mb-5">
              <a class="dwiggy_btn bg-ff bdr-rdius24 bdr-none gothambold-f15 color-f3" style="color: white;"  href="{{ get_setting('home_about_section_button_link_why') }}">Read More <img src="{{ route('home') }}/images/Icon ionic-ios-arrow-round-back@2x.png" style="width: 20px;"></a>
            </div>
          </div>
        </div>
        <div class="col">
          <div style="position: relative; left: 0; top: 0;">
            <img src="{{ route('home') }}/images/Rectangle 2924.png" class="borderr" />
            <img src="{{ uploaded_asset(json_decode(get_setting('home_about_section_image_why'), true)[0]) }}" class="girlwithpuppy" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="ddassa3">
      <div class="row">
        <div class="col-lg-7">
          <div class="dd_allCNT p-5">
            <h2 class="color-brown f-24 f-bold mb-4">{{ get_setting('home_about_section_heading_rewards') }}</h2>
              
              <?php echo htmlspecialchars_decode($str_word4); ?>

            <div class="Dwiggy_bnr_btn mb-5">
             <a class="dwiggy_btn bg-ff bdr-rdius24 bdr-none gothambold-f15 color-f3" style="color: white;"  href="{{ get_setting('home_about_section_button_link_rewards') }}">Read More <img src="{{ route('home') }}/images/Icon ionic-ios-arrow-round-back@2x.png" style="width: 20px;"></a>
            </div>
          </div>
        </div>
        <div class="col">
          <div style="position: relative; left: 0; top: 0;">
            <img src="{{ route('home') }}/images/Rectangle 2924.png" class="borderr" />
            <img src="{{ uploaded_asset(json_decode(get_setting('home_about_section_image_rewards'), true)[0]) }}" class="girlwithpuppy" />
          </div>
        </div>
      </div>
    </div>
...
@if (get_setting('home_world_section_heading') != null)
@php
 $str_word = json_decode(get_setting('home_world_section_content'), true)[0];
@endphp
<section class="pb-5 pt-4" style="background: url({{ json_decode(get_setting('home_world_section_background'), true)[0] }}) 100% 0 no-repeat;">
	
		<div class="dd_bgimg  g_life">
			<div class="row">
				<div class="col-lg-7">
					<div class="dd_allCNT p-5">
						<h2 class="color-brown f-32 f-bold mb-4">{{ get_setting('home_world_section_heading') }}</h2>
						
						<?php echo htmlspecialchars_decode($str_word); ?>
						<div class="Dwiggy_bnr_btn mb-5"> 
							<a class="dwiggy_btn bg-ff bdr-rdius24 bdr-none gothambold-f15 color-f3" style="color: white;" href="{{ get_setting('home_world_section_button_link') }}">COMMING SOON</a>
						</div>
					</div>
				</div>
			</div>
...
<section class="pt-5 pb-5">
    ...
    <div class="col-md-6  mb-4 <?php if($n==1){?> slideInLeft  <?php  } else { ?> slideInRight<?php }  ?>" data-wow-duration="1s" data-wow-delay="0s">
      <div class="dd_img">
        <img id="myImg<?php echo $n; ?>" alt="" src="{{ uploaded_asset($slider_images[$key]) }}" class="img-fluid">
        <div id="myModal<?php echo $n; ?>" class="modal">
          <span class="close<?php echo $n; ?>">&times;</span>
          <img class="modal-content" id="img01<?php echo $n; ?>" src="{{ uploaded_asset($slider_images[$key]) }}" >
          <br>
          <div class="centered">
...
<header class="header2">
  <div class="overlay"></div>
  <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
    <source src="{{ uploaded_asset($slider_data2[0]->banner_video)  }}" type="video/mp4">
    </video>
    <div class="container h-100">
      <div class="d-flex h-100 text-center align-items-center">
        <div class="w-100 text-white">
          <h1 class="head-cnt f-49 f-bold" >{{ $slider_data2[0]->title  }}</h1>
          <?php echo htmlspecialchars_decode($str2); ?>
          <div class="Dwiggy_bnr_btn mb-5"> 
            <a class="dwiggy_btn bg-ff bdr-rdius24 bdr-none gothambold-f15 signupnrb" href="{{ $slider_data2[0]->link  }}" style="color: white;">SIGN UP NOW!</a>
          </div>
        </div>
      </div>
    </div>
...
<header class="header2">
  <div class="overlay"></div>
  <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
    <source src="{{ uploaded_asset($slider_data3[0]->banner_video)  }}" type="video/mp4">
    </video>
    <!-- The header content -->
    <div class="container h-100">
      <div class="d-flex h-100 text-center align-items-center">
        <div class="w-100 text-white">
          <h1 class="head-cnt f-49 f-bold" >{{ $slider_data3[0]->title  }}</h1>
          <?php echo htmlspecialchars_decode($str3); ?>
          <div class="Dwiggy_bnr_btn mb-5"> 
            <a class="dwiggy_btn bg-ff bdr-rdius24 bdr-none gothambold-f15 signupnrb" href="{{ $slider_data3[0]->link  }}" style=" color: white;">KNOW ME</a>
          </div>			
        </div>
      </div>
    </div>
...
<?php  if(@$_GET['thnx']==1){  ?>
 <div class="pp_after">
  <div class="pp_after_body">
    <div class="pp_after_img"><img src="{{ route('home') }}/images/1.png" class="img-fluid"></div>
...
<script>
  ...
  responsive: [
    ...
    function submitans(val1,val2,val3,val4,val5,val6)
    {
      ...
      $.ajax({
            type:'POST',
            url:'{{env('APP_URL')}}/hsubmitquesdaily',
            data: {"val1":val1,"val2":val2,"val3":val3,"val4":val4,"val5":val5,"val6":val6,"_token": "{{ csrf_token() }}"},
    ...
    function sliderdynamic1(uid)
    {
      ...
      $.ajax({
            type:'POST',
            url:'{{env('APP_URL')}}/sliderdynamicuserc',
...
new SlideStories("slide"); 
     ...
     function sliderdynamic(uid)
    {
      ...
      $.ajax({
            type:'POST',
            url:'{{env('APP_URL')}}/sliderdynamicuser',
            data: {"uid":uid,"_token": "{{ csrf_token() }}"},
            success:function(data) {
                // alert(data);
                    $('#css').empty();
