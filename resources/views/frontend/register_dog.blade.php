				...
				<form method="post" action="{{route('home.store')}}"  enctype="multipart/form-data">
				  ...
				  <div class="form-row">
				    ...
				    <div class="form-group col-md-4 mb-4">
				    	...
				    	<img src="{{$value['file_path']}}" style="width: 50%;height: 100px;">
				            <?php  } else {   ?>
				    ...
				    <div class="form-group col-md-4 mb-4">
					    ...
					    // print_r($fgf[2]);
					      ...
					      if($fgf[2]=='jpg'||$fgf[2]=='jpeg'||$fgf[2]=='png'||$fgf[2]=='svg'||$fgf[2]=='jpg'||$fgf[2]=='gif'||$fgf[2]=='webp'||$fgf[2]=='jfif') {  ?>
				    	<img src="{{$value['file_path1']}}" style="width: 50%;height: 100px;">
				            <?php  } else {   ?>
								       <video width="225" height="100" controls>
				    ...
				    <div class="form-group col-md-4 mb-4">
					    ...
					    // print_r($fgf[2]);
					      ...
					      if($fgf[2]=='jpg'||$fgf[2]=='jpeg'||$fgf[2]=='png'||$fgf[2]=='svg'||$fgf[2]=='jpg'||$fgf[2]=='gif'||$fgf[2]=='webp'||$fgf[2]=='jfif') {  ?>
				    	<img src="{{$value['file_path2']}}" style="width: 50%;height: 100px;">
				            <?php  } else {   ?>
								       <video width="225" height="100" controls>
				    ...
				    <div class="form-group col-md-4 mb-4">
					    ...
					    // print_r($fgf[2]);
					      ...
					      if($fgf[2]=='jpg'||$fgf[2]=='jpeg'||$fgf[2]=='png'||$fgf[2]=='svg'||$fgf[2]=='jpg'||$fgf[2]=='gif'||$fgf[2]=='webp'||$fgf[2]=='jfif') {  ?>
				    	<img src="{{$value['file_path3']}}" style="width: 50%;height: 100px;">
				            <?php  } else {   ?>
								       <video width="225" height="100" controls>
				    ...
				    <div class="form-group col-md-4 mb-4">
					    ...
					    // print_r($fgf[2]);
					      ...
					      if($fgf[2]=='jpg'||$fgf[2]=='jpeg'||$fgf[2]=='png'||$fgf[2]=='svg'||$fgf[2]=='jpg'||$fgf[2]=='gif'||$fgf[2]=='webp'||$fgf[2]=='jfif') {  ?>
				    	<img src="{{$value['file_path4']}}" style="width: 50%;height: 100px;">
				            <?php  } else {   ?>
								       <video width="225" height="100" controls>
		  ...
		  <div class="tab-pane fade<?php if(Auth::user()->phone==''){ ?> show active<?php }  ?>" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
		  	...
		  	<div class="dwiggy-form">
				<form action="{{ route('customer.profile.update') }}" method="POST" enctype="multipart/form-data">
				  ...
				  <div class="form-row">
				    <div class="form-group	 col-md-4 mb-4">
				    	<input type="text" class="form-control" id="inputName4"  placeholder="Your Name*"  required  name="name" value="{{ Auth::user()->name }}">
	                    <!-- <label for="inputName">Your Name*</label> -->
				    </div>
				    <div class="form-group col-md-4 mb-4">
				      <input type="text" class="form-control" id="inputMobile4"  pattern="[1-9]{1}[0-9]{9}"    placeholder="Your phone*"  required  name="phone" value="{{ Auth::user()->phone }}">
				    ...
				    <div class="form-group col-md-4 mb-4">
				      <input type="email" class="form-control" id="inputEmail4" name="email" placeholder="Your Email"   value="{{ Auth::user()->email }}"  required>
				      <!-- <label for="inputEmail4">Enter your email</label> -->
				    </div>
				    <div class="form-group col-md-4 mb-4">
				      <input type="text" class="form-control" id="postal_code" name="postal_code" placeholder="Pincode"   value="{{ Auth::user()->postal_code }}" required>
				    </div>
				    <div class="form-group col-md-4 mb-4">
				      <input type="text" class="form-control" id="age" name="age" placeholder="Age"   value="{{ Auth::user()->age }}" required>
				    </div>
				    <div class="form-group col-md-4 mb-4">
				    ...
				    <?php  if(Auth::user()->avatar_original!=''){  ?>
				    	<img src="{{Auth::user()->avatar_original}}" style="width: 50%;height: 100px;">
				            <?php  }   ?>
				            </div>
				  </div>
				  <div class="dd_form_btn text-center pt-4">
