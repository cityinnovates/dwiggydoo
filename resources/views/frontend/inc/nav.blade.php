  <header style="background: white;">
    <div class="container pt-md-3" style="background-color: white">
      <div class="header-right justify-content-between d-flex align-items-center">
        <a class="dd_logo w-25" href="{{env('APP_URL')}}/"><img src="{{env('APP_URL')}}/images/lOGO.png" class="img-fluid"></a>
        <div class="dd_right_bar d-flex align-items-center justify-content-end w-75">
          <div class="search-header mr-md-4">
            <form method="get" action="{{env('APP_URL')}}/all-connections/" autocomplete="off" id="commentForm">
          ...
          <div class="header-right-icons d-flex">
            ...
            <a <?php if (isset(Auth::user()->id)) { ?> href="{{route('dashboard')}}" <?php   } else { ?> data-toggle="modal" data-target="#dynamicBackdrop" <?php } ?> class="mr-4">
              <i class="fal fa-user"></i>
            </a>
            <a href="{{env('APP_URL')}}/all-request">
    ...
    <nav class="navbar navbar-expand-lg main-nav px-0 py-1" id="navbarNav">
      <div class="container">
        ...
        <div class="header-right-icons d-none">
          <a <?php if (isset(Auth::user()->id)) { ?> href="{{route('dashboard')}}" <?php   } else { ?> data-toggle="modal" data-target="#staticBackdrop" <?php } ?> >
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarToggler">
          ...
          <ul class=" navbar-nav ">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('all_connections') }}" >CONNECTIONS </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('connections.breed') }}" >BREEDS </a>
            </li>
            @auth
            <li class="nav-item">
              <a class="nav-link" href="{{ route('dog_advice') }}">DOG ADVICE </a>
            </li><li class="nav-item">
              <a class="nav-link" href="{{ route('human_advice') }}">HUMAN ADVICE </a>
            </li>
            @endauth
            <li class="nav-item">
          ...
          <div class="dd_notification">
            ...
            <i class="fas fa-bell"></i><?php if (isset(Auth::user()->id)) { ?> | <a href="{{env('APP_URL')}}/logout" style="text-decoration: none;
      ...
      @auth
        ...
        <div class="foot">
          <a data-toggle="modal" data-target="#rewardpage">
            <img src="{{env('APP_URL')}}/images/about-banner/Group3395.png">
            <div class="centeringg" style="font-size: 10px;"><b>{{ $total_rewards }}</b></div>
          </a>
        </div>
        @endif
      @endauth
