		...
		<div class="row align-items-center">
			<div class="col-md-6 mb-4">
				<div class="owner_profile">
					<img src="{{ route('home') }}/images/owner_profile.png" class="img-fluid">
				</div>
			</div>
			<div class="col-md-6">
			      	...
			      	<div class="login_cnt text-center pb-5">
						...
						<div class="modal-footer" style="border: none;">
							...
							<div class="login_with w-100 text-center mb-3">
								<a href="https://dwiggydoo.com/login/instagram" class="mx-2"><img src="{{ route('home') }}/images/login_with/instagram.png"></a>
								<a href="https://dwiggydoo.com/social-login/redirect/google" class="mx-2"><img src="{{ route('home') }}/images/login_with/google.png"></a>
								<!-- <a href="#" class="mx-2"><img src="{{ route('home') }}/images/login_with/spotify.png"></a> -->
...
function sendotp(value){
   ...
   if(filter.test(mobile)){
    $.ajax({
            type:'POST',
            url:'{{env('APP_URL')}}/sendotptomobiler',
             data: {"email": email, "_token": "{{ csrf_token() }}","name":name,"mobile":mobile,
