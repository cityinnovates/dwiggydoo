...
<head>
  ...
  @if(Session::get('is_plan_active') ==1)
  <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}/css/subscribe.css">
  @endif
  <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}/js/main.js">
...
<body @if(Session::get('is_plan_active')==1) class="paid_user user_has_plan" @endif>
  ...
  <!-- Login Modal -->
  @include('frontend.modals.login_popup')

    <!--show rewards points-->
  @include('frontend.modals.show_rewards_points')
  ...
  <div class="dd-text1"><img src="{{env('APP_URL')}}/images/text.png" class="img-fluid"></div>
  <div class="dd-text2"><img src="{{env('APP_URL')}}/images/text2.png" class="img-fluid"></div>
  ...
  @include('frontend.inc.common_script')
