          ...
          <div class="modal-body">
           <div class="centerele d-flex justify-content-center">
            @if (Auth::user()->avatar_original != null)
                <img src="{{ Auth::user()->avatar_original }}" class="image rounded-circle" style="max-width: 150px">
            @else
                <img src="{{ static_asset('assets/img/avatar-place.png') }}" class="image rounded-circle" style="max-width: 150px">
            @endif
