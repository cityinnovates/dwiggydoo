					...
					<div class="row align-items-center">
						<div class="col-lg-6 col-md-12">
							<div class="bl_Convers_img pos-rel">
							    <div id="connect_gallery<?=$key?>" class="carousel slide" data-ride="carousel">
								  <ol class="carousel-indicators">
								    <li data-target="#connect_gallery<?=$key?>" data-slide-to="0" class="active">
										...
										<img src="{{ uploaded_asset($value->thumbnail_img) }}" >
									    <?php  }   ?>
								    </li>
								    ...
								    <div class="carousel-item active">
								     <?php  if($value->file_path!=''){ $fgf=explode('.',$value->file_path); 
									   if($fgf[2]=='jpg'||$fgf[2]=='jpeg'||$fgf[2]=='png'||$fgf[2]=='webp'||$fgf[2]=='svg'||$fgf[2]=='jpg'||$fgf[2]=='gif') {  ?>
										...
										<img src="{{ $value->file_path }}" class="d-block w-100" alt="..." height="227px">	
									    <?php  } else {   ?>
										...
										<img src="{{ uploaded_asset($value->thumbnail_img) }}" class="d-block w-100" alt="..." height="227px">
										<?php  }   ?>
								    </div>
									<?php } ?>
								    ...
								    <div class="carousel-item">
								     <?php  if($value->file_path1!=''){
									   ...
									   if($fgf[2]=='jpg'||$fgf[2]=='jpeg'||$fgf[2]=='png'||$fgf[2]=='webp'||$fgf[2]=='svg'||$fgf[2]=='jpg'||$fgf[2]=='gif') {  ?>
										...
										<img src="{{ $value->file_path1 }}" class="d-block w-100" alt="..." height="227px">	
								    ...
								    <div class="carousel-item">
								     <?php  if($value->file_path2!=''){ $fgf=explode('.',$value->file_path2); 
									   if($fgf[2]=='jpg'||$fgf[2]=='jpeg'||$fgf[2]=='png'||$fgf[2]=='webp'||$fgf[2]=='svg'||$fgf[2]=='jpg'||$fgf[2]=='gif') {  ?>
										...
										<img src="{{ $value->file_path2 }}" class="d-block w-100" alt="..." height="227px">	
								    ...
								    <div class="carousel-item">
								     <?php  if($value->file_path3!=''){ $fgf=explode('.',$value->file_path3); 
									   if($fgf[2]=='jpg'||$fgf[2]=='jpeg'||$fgf[2]=='png'||$fgf[2]=='webp'||$fgf[2]=='svg'||$fgf[2]=='jpg'||$fgf[2]=='gif') {  ?>
										...
										<img src="{{ $value->file_path3 }}" class="d-block w-100" alt="..." height="227px">	
								    ...
								    <div class="carousel-item">
								     <?php  if($value->file_path4!=''){ $fgf=explode('.',$value->file_path4); 
									   if($fgf[2]=='jpg'||$fgf[2]=='jpeg'||$fgf[2]=='png'||$fgf[2]=='webp'||$fgf[2]=='svg'||$fgf[2]=='jpg'||$fgf[2]=='gif') {  ?>
										...
										<img src="{{ $value->file_path4 }}" class="d-block w-100" alt="..." height="227px">	
								...
								<div class="bl_Convers_heart <?= !empty($wishlist->id)? 'active': ''; ?>" onclick="wishlist_items({{ Auth::user()->id }}, {{ $value->id }});">
							...
							<div class="row align-items-center">
								<div class="col-md-6">
									<div class="bl_Convers_cnt bdr-none">
										<strong class="f-18 f-sbold color-00 mb-2">{{ @$value->name}}</strong>
								...
								<div class="col-md-6">
									<div class="act_frnd text-right">
										...
										<ul class="act_frnd_list mb-0" style="bottom: -97px;">
											<li><a href="{{ route('connections_unfriend', $value->id) }}"><button  class="d-flex justify-content-center bdr_btm_light gotham-medium f-16 bg-trsprnt bdr-none w-100"><img src="images/sad.png"> <span class="w-50 text-left pl-4">Unfriend</span></button></a></li>
											<li><a href="{{ route('connections_block', $value->id) }}"><button class="d-flex justify-content-center bdr_btm_light gotham-medium f-16 bg-trsprnt bdr-none w-100"><img src="images/cry.png"> <span class="w-50 text-left pl-4">Block</span></button></a></li>
											<li><a href="{{ route('connections_report', $value->id) }}"><button class="d-flex justify-content-center  gotham-medium f-16 bg-trsprnt bdr-none w-100"><img src="images/dead.png"> <span class="w-50 text-left pl-4">Report</span></button></a></li>
										</ul>
									</div>
									...
									<div class="tab-pane fade show active" id="home<?=$key?>" role="tabpanel" aria-labelledby="home-tab<?=$key?>">
										<div class="bl_Convers_img pos-rel">
											@if (Auth::user()->avatar_original != null)
							                    <img src="{{ Auth::user()->avatar_original }}" class="image rounded-circle">
							                @else
...
<?php foreach ($products as $key => $products){  ?>   
    ...
    height: 80px;">
				    	...
				    	<img style="width: 80px; height: 80px; border-radius: 50%;object-fit: cover;" src="{{$products->file_path}}" >
									            <?php  } else {   ?>
					       <video style="width: 80px; height: 80px; border-radius: 50%;object-fit: cover;" controls>
					       <source src="{{$products->file_path}}" type="video/mp4">
					       Your browser does not support the video tag.
					      </video>   			
									        <?php }    ?>
							...
							<div class="fsuggetion_cnt">
								<h3 class="f-25 f-sbold color-27 mb-3">{{ $products->name}}</h3>
...
<button type="button" style="background: #008bb7;" class="btn btn-primary"><svg class="svg-inline--fa fa-user-plus mr-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg=""><path fill="currentColor" d="M224 256c70.7 0 128-57.31 128-128S294.7 0 224 0C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3C77.61 304 0 381.6 0 477.3C0 496.5 15.52 512 34.66 512h378.7C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304zM616 200h-48v-48C568 138.8 557.3 128 544 128s-24 10.75-24 24v48h-48C458.8 200 448 210.8 448 224s10.75 24 24 24h48v48C520 309.3 530.8 320 544 320s24-10.75 24-24v-48h48C629.3 248 640 237.3 640 224S629.3 200 616 200z"></path></svg><!-- <i class="fas fa-user-plus mr-2"></i> Font Awesome fontawesome.com -->Request sent</button>
    	  ...
    	  <a <?php if(@isset(Auth::user()->id)){?> href="https://dwiggydoo.com/send_request/{{$products->id}}"  <?php  } else {  ?> data-toggle="modal" data-target="#staticBackdrop" <?php  }  ?>>	<button type="button" class="btn btn-primary"><svg class="svg-inline--fa fa-user-plus mr-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg=""><path fill="currentColor" d="M224 256c70.7 0 128-57.31 128-128S294.7 0 224 0C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3C77.61 304 0 381.6 0 477.3C0 496.5 15.52 512 34.66 512h378.7C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304zM616 200h-48v-48C568 138.8 557.3 128 544 128s-24 10.75-24 24v48h-48C458.8 200 448 210.8 448 224s10.75 24 24 24h48v48C520 309.3 530.8 320 544 320s24-10.75 24-24v-48h48C629.3 248 640 237.3 640 224S629.3 200 616 200z"></path></svg><!-- <i class="fas fa-user-plus mr-2"></i> Font Awesome fontawesome.com -->Send Request</button></a>  	
