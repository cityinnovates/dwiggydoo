...
<style type="text/css">
	.user_has_plan .color-f3{color:#58bed7;}
</style>
@endsection


@section('content')
<section class="occu_love_sec py-5 bg_heart">
	<div class="container">
		<div class="row">
			<div class="col-12 mb-5 mt-4">
				<h1 class="f-bold dd_heading f-40 color-f3 text-center breed-ctn pos-rel mb-2">Occupational love
				</h1>
			</div>
		</div>
		<section>
			<div class="container septype">
				...
				<div class="row" style="text-align: center;  ">
					...
					<div class="col " id="heading22">
						<a" class="thn" onclick="mytabris2()">Requirement</a>
					</div>
				...
				<div class="container " id="firsttab">
					...
					<div class="dd_thoght_text22 d-flex align-items-center px-4 py-2">
						<div class=" mr-4"><i class="fa-regular fa-face-smile"></i> | <b>@hemantvarshney </b></div>
						<div class="dd_text_input"><input type="text" placeholder="Woof your thoughts" class="w-75 f-reg color-00 f-18 bg-trsprnt bdr-none"></div>
						<div class="dd_upload d-flex justify-content-between">
							<div class="col-md-12 text-center">
								<button class="dwiggy_btn bg-ff bdr-none gothambold-f15 " style="background-color:Tomato; color: white; border-radius: 25px;">SEND</button>
...
<section class="dd_priorities my-5">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-12 mb-5 mt-4">
				<h1 class="f-bold dd_heading f-35  text-center breed-ctn pos-rel " style="color: #000">Change Preference
				</h1>
				<div class="lineer">
			...
			<div class="col-md-5 mb-4">
				<h3 class="f-bold f-24 color-27 text-center  breed-ctn pos-rel m-5">Change Profession
				</h3>

					<div class="form-row">
						<div class="form-group	col-12 mb-4">
							<select class="form-control srch-form px-4 bdr-rdius6 color-f3 f-sbold gotham-book bdr-f3"  id="profession_id" name="profession_id" required>
			...
			<div class="col-md-2 mb-4">
				<div class="bg_color bg-f3 mt-5"></div>
			</div>
			<div class="col-md-5 mb-4">
				<h3 class="f-bold f-24 color-27 text-center  breed-ctn pos-rel m-5">Change Priorities
				</h3>

					<div class="form-row">

						<div class="form-group	col-12 mb-4">
							<select class="form-control srch-form px-4 bdr-rdius6 color-f3 f-sbold gotham-book bdr-f3"  id="priorities_profession_id" name="priorities_profession_id" required>
								<option value="">{{ ('Select Profession') }}*</option>
							@foreach(App\Models\ProfessionCategory::all() as $key => $value)
		...
		<div class="container ">
			<div class="col-md-12 text-center">
				<button class="dwiggy_btn bg-ff bdr-none gothambold-f15 " style="background-color:Tomato; color: white; border-radius: 10px;"> Let's Go!</button>
...
<section class="bg-yellow py-5">
	<div class="container">
		<div class="row">
			<div class="col-12 mb-5 mt-4">
				<h1 class="f-bold dd_heading f-40 color-27 text-center breed-ctn pos-rel mb-5">Profession of the Month
				</h1>
				<p class="f-20 f-reg color-27 mb-4 text-center">About : Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."About : Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
				<p class="f-16 f-reg color-27 mb-4 text-center px-md-5 mb-5">About : Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."About : Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-12 text-center">
				<div class="prf_otm text-center">
					<img src="images/new_xd_images/richard-brutyo.png" class="img-fluid mb-4">
					<h4 class="f-bold f-30 color-27">Julie</h4>
				</div>
			</div>
		</div>
	</div>
